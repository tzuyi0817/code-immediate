...
const HANDLE_SEPARATE_MAP = {
  ...
  '@component-hook/picker/vue': `${JSDELIVR_CDN}/@component-hook/picker@1.1.5-alpha.0/dist/vue/picker.es.js`,

  '@component-hook/pdf-canvas/react': `${JSDELIVR_CDN}/@component-hook/pdf-canvas/dist/react/pdf-canvas.es.js`,
  '@component-hook/picker/react': `${JSDELIVR_CDN}/@component-hook/picker@1.1.5-alpha.0/dist/react/picker.es.js`,
} as const;
